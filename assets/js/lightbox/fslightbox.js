    ...
    (() => {
        ...
        function k(t) {
            ...
            (this.a = function (i) {
                ...
                (this.s = function () {
                    c(s.current, 'z'),
                        void 0 !== s.previous && o.swipedX > 0 ? c(s.previous, 'ne') : void 0 !== s.next && o.swipedX < 0 && c(s.next, 'p');
                }),
                (this.zs = function (t) {
                        ...
                        !(function (t) {
                            ...
                            (function (t) {
                                ...
                                function C() {
                                    ...
                                    u[arguments.length > 2 ? arguments[2] : void 0].style.transform = 'translateY('
                                        .concat(t, 'px) scale(')
                                        .concat(e, ')');
                                }
                                (c.r = function () {
                                    innerWidth < 992 ? (t.mw = innerWidth) : (t.mw = 0.9 * innerWidth),
